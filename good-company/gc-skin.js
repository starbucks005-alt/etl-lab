...
var GC_SKINS = [
  ...
  { key:'tidepool', label:'Tidepool', swatch:['#A33E70','#06B8BC','#EAD7E0'] },
  { key:'confetti', label:'Confetti', swatch:['#F8A49E','#7E7244','#EED4D2'] },
  { key:'blueprint', label:'Blueprint', swatch:['#BB894C','#6498C4','#0F1E29'] },
  { key:'umber', label:'Umber', swatch:['#825831','#7E5F44','#EAE0D7'] },
  { key:'blaze', label:'Blaze', swatch:['#FDA829','#EF394F','#291F0F'] },
  { key:'understory', label:'Understory', swatch:['#A2B645','#A4B474','#232711'] },
  { key:'wildflower', label:'Wildflower', swatch:['#FEB641','#447E56','#EEE4D2'] },
  { key:'twilight', label:'Twilight', swatch:['#9D3C81','#453C85','#ECD4E5'] },
  { key:'alpine', label:'Alpine', swatch:['#405265','#445F7E','#D2E0EE'] },
  { key:'canopy', label:'Canopy', swatch:['#3FA75A','#A8B474','#142418'] },
  { key:'amethyst', label:'Amethyst', swatch:['#5740A8','#444A7E','#DBD7EA'] },
  { key:'driftwood', label:'Driftwood', swatch:['#D7AE96','#7E7E44','#EADED7'] },
  { key:'orchard', label:'Orchard', swatch:['#6642AE','#538939','#DDD7EA'] },
  { key:'terrarium', label:'Terrarium', swatch:['#41AA92','#53D5B4','#142421'] },
  { key:'bordeaux', label:'Bordeaux', swatch:['#8E201A','#FF2948','#241514'] },
  { key:'copper', label:'Copper', swatch:['#522C1F','#74B4A5','#241814'] },
  { key:'tide', label:'Tide', swatch:['#B08EB7','#3A6787','#EAD2EE'] },
