...
var GC_SKINS = [
  ...
  { key:'bramble', label:'Bramble', swatch:['#0A385F','#2B6397','#E9EEF2'] },
  { key:'tidepool', label:'Tidepool', swatch:['#A33E70','#06B8BC','#F1E9ED'] },
  { key:'confetti', label:'Confetti', swatch:['#F8A49E','#7E7244','#F2E9E9'] },
  { key:'blueprint', label:'Blueprint', swatch:['#BE8F55','#35658D','#F2EEE9'] },
  { key:'umber', label:'Umber', swatch:['#825831','#7E5F44','#F2EDE9'] },
  { key:'blaze', label:'Blaze', swatch:['#FDB13F','#EF394F','#1D1811'] },
  { key:'understory', label:'Understory', swatch:['#BBCA72','#A4B474','#1B1D11'] },
  { key:'wildflower', label:'Wildflower', swatch:['#FEB641','#447E56','#F2EEE9'] },
  { key:'twilight', label:'Twilight', swatch:['#9D3C81','#453C85','#F2E9EF'] },
  { key:'alpine', label:'Alpine', swatch:['#405265','#445F7E','#E9EDF2'] },
  { key:'canopy', label:'Canopy', swatch:['#72CA89','#A8B474','#131B15'] },
  { key:'amethyst', label:'Amethyst', swatch:['#5740A8','#444A7E','#ECEBF0'] },
  { key:'driftwood', label:'Driftwood', swatch:['#D7AE96','#7E7E44','#F0EDEB'] },
  { key:'orchard', label:'Orchard', swatch:['#6642AE','#538939','#ECE9F1'] },
  { key:'terrarium', label:'Terrarium', swatch:['#72CAB5','#53D5B4','#111D1A'] },
  { key:'bordeaux', label:'Bordeaux', swatch:['#8E201A','#69BF6E','#1D1211'] },
  { key:'copper', label:'Copper', swatch:['#522C1F','#74B4A5','#1D1411'] },
  { key:'tide', label:'Tide', swatch:['#B08EB7','#3A6787','#F0E9F2'] },
  { key:'slate', label:'Slate', swatch:['#3E4A4B','#506672','#EDEDED'] }
];
