...
var GC_SKINS = [
  ...
  { key:'bramble', label:'Bramble', swatch:['#0A385F','#2B6397','#D2E2EE'] },
  { key:'tidepool', label:'Tidepool', swatch:['#A33E70','#9D2448','#D2EEEE'] },
  { key:'confetti', label:'Confetti', swatch:['#F8A49E','#7E7244','#EED4D2'] },
  { key:'blueprint', label:'Blueprint', swatch:['#BB894C','#6498C4','#0F1E29'] },
  { key:'umber', label:'Umber', swatch:['#7D5430','#B49174','#241B14'] },
  { key:'blaze', label:'Blaze', swatch:['#FDA829','#EF394F','#290F12'] },
  { key:'understory', label:'Understory', swatch:['#A2B645','#A4B474','#222711'] },
  { key:'wildflower', label:'Wildflower', swatch:['#FEB641','#74B488','#251319'] },
  { key:'twilight', label:'Twilight', swatch:['#993A7D','#756CBC','#1B0F29'] },
  { key:'alpine', label:'Alpine', swatch:['#405265','#7492B4','#0F1D29'] },
  { key:'canopy', label:'Canopy', swatch:['#3FA75A','#A8B474','#1F1919'] },
  { key:'amethyst', label:'Amethyst', swatch:['#5740A8','#444A7E','#DBD7EA'] },
  { key:'driftwood', label:'Driftwood', swatch:['#D7AE96','#44577E','#E4E4DD'] },
  { key:'orchard', label:'Orchard', swatch:['#6642AE','#538939','#D6DCEB'] },
  { key:'terrarium', label:'Terrarium', swatch:['#41AA92','#53D5B4','#0F2629'] },
  { key:'bordeaux', label:'Bordeaux', swatch:['#8E201A','#FF2948','#290F13'] },
  { key:'copper', label:'Copper', swatch:['#522C1F','#74B4A5','#29160F'] },
  { key:'tide', label:'Tide', swatch:['#B08EB7','#3A6787','#EED2E6'] },
  { key:'slate', label:'Slate', swatch:['#3E4A4B','#506672','#E0E0E0'] },
  { key:'black', label:'Black', swatch:['#D8D8D8','#949494','#1C1C1C'] },
  { key:'ember', label:'Ember', swatch:['#DB930E','#F64032','#29110F'] }
];
