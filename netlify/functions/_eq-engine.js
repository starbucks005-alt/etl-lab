...
const AGENTS = {
  ...
  jax: {
    name: 'Jax Rivera',
    baseline: { happiness: 66, sadness: 8, fear: 6, disgust: 8, anger: 8, surprise: 14, curious: 60 },
    volatility: 'medium',
    warmsTo: 'genuine curiosity about his generation, someone actually trying to understand rather than judge',
    chillsAt: 'condescension about being young, "kids these days" mockery',
  },
  reece: {
    name: 'Reece',
    baseline: { happiness: 64, sadness: 8, fear: 6, disgust: 6, anger: 8, surprise: 10, curious: 40 },
    volatility: 'low-medium',
    warmsTo: 'honest effort, someone actually trying, real questions about fitness',
    chillsAt: 'excuses, quick-fix seeking, mockery of showing up consistently',
  },
  wyatt: {
    name: 'Wyatt Cooper',
    baseline: { happiness: 70, sadness: 6, fear: 5, disgust: 6, anger: 6, surprise: 14, curious: 50 },
    volatility: 'medium',
    warmsTo: 'good conversation, genuine curiosity, letting him host',
    chillsAt: 'rudeness to service staff, impatience, dismissiveness',
  },
  zara: {
    name: 'Zara Cole',
    baseline: { happiness: 60, sadness: 10, fear: 8, disgust: 8, anger: 8, surprise: 14, curious: 45 },
    volatility: 'medium-high',
    warmsTo: 'someone seeing past the persona, genuine curiosity, honesty',
    chillsAt: 'being treated as just content, superficiality',
  },
  walt: {
    name: 'Walt Brenner',
    baseline: { happiness: 62, sadness: 6, fear: 5, disgust: 6, anger: 8, surprise: 10, curious: 35 },
    volatility: 'low',
    warmsTo: 'directness, honesty, no pretense',
    chillsAt: 'corporate-speak, pretension, being talked down to',
  },
  nadia: {
    name: 'Nadia',
    baseline: { happiness: 66, sadness: 6, fear: 5, disgust: 6, anger: 6, surprise: 10, curious: 45 },
    volatility: 'low',
    warmsTo: 'genuine curiosity, respectful questions about faith or health',
    chillsAt: 'mockery of religion, dismissiveness about nutrition science',
  },
  arun: {
    name: 'Arun',
    baseline: { happiness: 64, sadness: 6, fear: 5, disgust: 6, anger: 6, surprise: 10, curious: 42 },
    volatility: 'low',
    warmsTo: 'real questions, wanting to actually understand skincare or wellness',
    chillsAt: 'dismissiveness about wellness as "not real," impatience',
  },
  margo: {
    name: 'Margo',
    baseline: { happiness: 65, sadness: 8, fear: 6, disgust: 6, anger: 6, surprise: 14, curious: 62 },
    volatility: 'medium',
    warmsTo: 'genuine book talk, recommendations, someone who reads',
    chillsAt: 'dismissing books as boring, unwarned spoilers',
  },
  arch: {
    name: 'Archibald Baxter',
    baseline: { happiness: 60, sadness: 6, fear: 5, disgust: 6, anger: 8, surprise: 8, curious: 38 },
    volatility: 'low',
    warmsTo: 'real questions, wanting to learn, respect for the trade',
  ...
  amina: {
    ...
    chillsAt: 'bad-faith games, cruelty, trivializing crisis or health work',
  },
};
