// Tests Dr. O's own exact original prompt, word for word, against Isabelle's
// real portrait (loosened crop-v2) -- the one combination never actually
// tried: her simple, previously-successful wording, not my elaborated
// rewrite, on her own photo rather than Sophia's. One-off, secret-gated,
// deleted after use.
const { getStore, connectLambda } = require('@netlify/blobs');
const sharp = require('sharp');
const veo = require('./_veo-video.js');
const SECRET = 'origprompt-Ky7wDm';

// Exact, unmodified, as she sent it.
const PROMPT = 'A seamless infinite loop of a person active listening, looking at the camera. ' +
  ...
  'movement, fluid and natural repetition where the ending seamlessly matches the starting ' +
  'frame, no jump cuts.';
