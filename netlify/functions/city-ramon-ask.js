/* city-ramon-ask - public, no auth. Sync trigger for Ramon Delgado (city services). */
...
exports.handler = async function(event) {
  ...
  const bgUrl = base + '/.netlify/functions/city-ramon-background';
  ...
  return {
    statusCode: 200,
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ ok: true, job_id: jobId, polling_endpoint: '/.netlify/functions/city-ramon-status?job_id=' + jobId }),
  };
};
