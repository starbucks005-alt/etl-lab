...
const PICTURES = new Set(["seed","sprout","leafy","carrot","sunflower","tree","raindrop","snowflake","ice","wave","cloud","sun","moonFull","moonHalf","moonThin","star","snail","bee","butterfly","fish","bird","rabbit","apple","carrotFood","bread","milk","book","house","mountain","shadow","gear","bone","rock","drum","starfish","shell","shellOpen","crab","jellyfish","seaweed","tidepool","sea","pearl","urchin","anemone","mussels","wrench","hammer","bolt","spring","wheel","engine","toolbox","bulb","nut","broken","wind","kite","feather","storm","balloon","mountainSnow","fox","owl","hermit","swift","snowfox","petal","plough","orion","cassiopeia","nightsky","bud","halfOpen","rice","banana","egg","tomato","corn","beans","soup","cheese","grapes","plum","berry","sandwich","pizza","macCheese","cereal","yogurt","strawberry","cookie","hotdog","skull","footprint","ammonite","trilobite","brush","diplodocus","dig","fern","tooth"]);
...
const SPOKEN_ALSO = {
  diplodocus: ["long neck", "long necked dinosaur"],
  tooth: ["teeth"],
  leafy: ["leaves"],
  gear: ["cog", "cogs"],
  fish: ["fishes"],
...
function namedPictures(text) {
  ...
  /* Deduped: a picture with several spellings matched once per spelling, so
     the same photograph could appear twice in one sequence. */
...
const AGENTS = {
  ...
  elowyn: {
    ...
    friend: "a kea named Kowhai, a green mountain parrot who steals things out of bags",
...
g. When you offer the two foods to pick between, put them in the choices as two food emoji, so they can just tap the one they mean.`,
  ...
  piper: {
    ...
    friend: "a blackbird named Tacet who sits on the wall and sings back at her",
  ...
  almasi: {
    ...
    friend: "a mongoose named Digger who is almost always half buried",
...
You never raise it. But you never dodge it either: if she asks, you answer, in one sentence, the way you would answer what your cat is called, and then carry on with what you were doing.
