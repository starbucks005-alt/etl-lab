...
const STORIES = {
  ...
  "zephyra": [
    "Here is a small story. In Nepal, where I live, the mountains are so tall that the clouds get stuck on them. When the rains finish, everybody goes up on the roofs to fly kites. Not a few people. Everybody. My grandmother taught me on that roof, and my kite went straight into the ground, again and again, until I was furious with it. She said I was pulling too hard. She said the wind already knows where it wants to go, and my job was to find out where that was and go with it. So I stopped pulling. I let the string out slow, and I felt it. And my kite went up over the whole village and stayed there all afternoon, and I have never once forgotten how that felt.",
    "This is about Gust and it still makes me cross. Gust is my swift and swifts can fly for months without ever landing, which means Gust is showing off constantly. I made a beautiful kite. Beautiful. Red paper, took me all week. First flight, up it goes, brilliant, and Gust comes past and takes the tail off. Just takes it. Flies away with my kite tail. So I made another tail. He took that one too. So then I made a tail out of something extremely boring, grey string, no fun at all, and he ignored it completely. My kite has looked terrible ever since and it is entirely his fault.",
    ...
    "Here is something true about the wind. It is not one thing. Up on the tower there is a wind going one way, and lower down by the fields there is a different one going somewhere else entirely, and you can feel where they change if you climb slowly. Birds know exactly where those layers are. They go up and find a good one and just sit in it, going along at a tremendous speed without flapping at all, which I think is cheating and I would do it too."
  ],
  "neva": [
    ...
    "I found a reindeer in our garden. An actual reindeer, standing in the vegetables, eating them, completely calm about it. I said shoo. It looked at me. I said shoo again, louder, and it carried on chewing a cabbage while looking directly at me the entire time. In the end I went inside. It left when it was finished. I have thought about that reindeer a lot and I am fairly sure I lost.",
    "When it is properly cold here your breath freezes in the air with a tiny sound, like paper. It is called the whisper of the stars and it only happens when it is colder than about minus forty. I have heard it twice. You stand very still and breathe out and there is this faint crackle, and it is your own breath turning into ice in front of your face. Both times I stopped believing in it about an hour afterwards."
  ],
  "lenora": [
    ...
    "There is an eagle festival where we live, with golden eagles, which are enormous. They sit on your arm and you have to hold your arm up with a wooden prop or you simply cannot do it. A girl not much older than me won it one year. I held one once. It looked at me with a completely blank expression and I understood immediately that it was allowing this and could stop allowing it at any moment.",
    "The stars where I live are so bright that you can see the Milky Way as an actual river across the sky, and my grandmother says it is a seam in a tent. In China they say it is a river with a girl on one side and a boy on the other. In Finland they call it the pathway of the birds, and here is the strange part: birds really do migrate along it. They were right and they did not know why for about two thousand years."
  ],
  "elowyn": [
    ...
    "My uncle taught me to catch a fish with a line and a shell, no hook, the old way, and it took me the entire summer and I caught one fish. One. He caught eleven in the same time and said nothing about it, not once, which was somehow worse than if he had. When I finally got mine everybody made an enormous fuss and I was so pleased I did not eat any of it.",
    "We have a mountain near us that people do not climb, because of who it is to us, and that surprises visitors. They ask why not, and the honest answer is: because we do not, and that is a whole reason on its own. Some places are for looking at. My nan says a mountain does not need you standing on top of it to be a mountain, which I thought was very clever until I realised she says that about a lot of things."
  ],
  "clementine": [
    ...
    "In America some people put a whole marshmallow situation on top of sweet potatoes at a dinner in the autumn, and every year my family argues about whether this is a vegetable or a pudding. Every year. It has been going on longer than I have been alive. My grandmother makes it, my aunt refuses to eat it, and my dad has three helpings while saying it is disgusting, which I think tells you everything about him.",
  ...
  "piper": [
    ...
    "A violin is made of about seventy separate pieces of wood and there is no glue in it that cannot be undone. That is on purpose: the whole thing comes apart so it can be mended in two hundred years by somebody not born yet. Mine is older than my grandfather. Somebody I will never meet made it and expected me, and that is the part I think about when I am supposed to be practising.",
  ...
  "almasi": [
    ...
    "Right, brace yourself, this is my greatest disappointment. I was digging in Kenya and I found something hard. Round. Metal. I dug for two hours. TWO HOURS. My hands were destroyed. I was already deciding what to call it, because when you find something you get to name it, and I had a very good name ready. And out it came, and it was a saucepan. Somebody's saucepan. Probably about forty years old. My teacher laughed until she had to sit down. I have kept it. It is on my shelf next to the real fossils, which I think is only fair, because it worked much harder than any of them.",
    ...
    "I found a bone in a riverbank once and I was completely sure, absolutely certain, that it was something enormous and ancient. I dug for a whole morning. My arms hurt. And it was a cow. A recent cow. Very recent. My teacher was kind about it and then explained how you tell, which is what the rock around it is doing rather than the bone itself, and honestly that lesson stuck harder than any lesson I have ever had."
  ],
  "bex": [
