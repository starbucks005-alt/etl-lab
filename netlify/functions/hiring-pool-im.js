...
function buildSystem(name, role, tagline, platform, skills) {
  return [
    ...
    '- The mission is not technology. It is people. The Dose was built for people who are lonely and need a companion who happens to know things. The Gauntlet was built for people with an idea and no one to trust it to. Founder Studio was built for people who deserve a real company but cannot afford a team.',
    '',
