...
function resumeAudienceRules(audience) {
  if (audience === 'pros') {
    return 'PROFESSIONAL CV RULES: this is a mid-career or senior candidate. ' +
           ...
           'CREDENTIAL EVALUATION RULES (critical): not all credentials are padding. ' +
           'Distinguish OPERATOR-GRADE SME credentials from generic professional ' +
           'development. Operator-grade credentials EARN their place and EXPLAIN how ' +
           'the candidate became who they are. NEVER recommend cutting them; if ' +
           'anything, recommend moving them forward when they are the differentiator. ' +
           'Operator-grade examples: OSINT training, behavioral analysis or criminal ' +
           'profiling, counter-terrorism training (JCITA, BBII, MCFP, JTTF-adjacent), ' +
           'intelligence analysis tradecraft, security clearance levels and handling ' +
           '(TS, TS/SCI, DoE Q), federal advisory board credentialing (FBI advisory, ' +
           'DHS advisory, JCS-related, NSC-adjacent), IRB or IACUC chair training, ' +
           'AAALAC, clinical specialty certifications that gate specific scope of ' +
           'practice, nonverbal communication / interview techniques (Reid, SCAN, ' +
           'kinesics), dual-use or export-control training, OPSEC training, weapons ' +
           'of mass destruction (CBRN, WMD) responder credentials, federal classified ' +
           'instructor certifications, named-program training (FBI, DHS, DoD schools), ' +
           'and similar SME-defining credentials. ' +
           'Generic professional development (basic PM refreshers, HR workshops, ' +
           'mandatory compliance modules, single-day conference attendance certificates ' +
           'unrelated to a specialty) CAN be condensed or moved later. ' +
           'The test: does this credential explain how the candidate earned the right ' +
           'to do a specific kind of work that few peers can do, or is it a generic ' +
           'skill marker? If the first, FOREGROUND it. If the second, condense. ' +
           'NEVER recommend cutting a credential block without examining what is in it. ' +
           'When a candidate has operator credentials AND emerging-tech / AI work, ' +
           'the fusion is usually the differentiator - the AI work is more credible ' +
           'because of the credentials, and the credentials are more current because ' +
           'of the AI work. Name the fusion explicitly.';
  }
