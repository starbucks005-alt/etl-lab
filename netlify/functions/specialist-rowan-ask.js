/* specialist-rowan-ask — sync trigger for Rowan Tate's Quant backpack. */
...
exports.handler = async function(event) {
  ...
  const bgUrl = base + '/.netlify/functions/specialist-rowan-background';
  ...
  return {
    ...
    body: JSON.stringify({ ok: true, job_id: jobId, polling_endpoint: '/.netlify/functions/specialist-rowan-status?job_id=' + jobId }),
  };
};
