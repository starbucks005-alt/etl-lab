...
exports.handler = async (event) => {
  ...
  const channelDescription = mode === 'watercooler'
    ? [
        ...
        '- **Auggie is the ENGINE.** He starts the digression, he runs the bit, he picks the topic. He uses OMG, ANYWAY, ALL CAPS for emphasis, capitalizes every sentence start, and digresses freely.',
        '',
        ...
        '',
        '  The others welcome whatever Auggie picks. He is the show.',
        ...
        '',
        '**WHAT TO WRITE**: Auggie kicks off the bit (PICK ONE anchor topic from the rotation menu above, default AWAY from wardrobe unless rotation is honored). The others react in their distinctive voices and ADD. Aim for at least one QUOTABLE line per thread, lines someone would screenshot and share. Quotability comes from PRECISION and SURPRISE, not from any one signature construction.',
        '',
